...
public class ClassParser {
    ...
    public static ClassBean parse(TypeDeclaration pClassNode) {
        ...
        Collection<FieldDeclaration> instanceVariableNodes = new ArrayList<FieldDeclaration>();
        ...
        Collection<MethodDeclaration> methodNodes = new ArrayList<MethodDeclaration>();
        pClassNode.accept(new MethodVisitor(methodNodes));

        // Get the method beans from the method nodes
        Collection<MethodBean> methodBeans = new ArrayList<MethodBean>();
        ...
        for (MethodBean classMethod : methodBeans) {
            ...
            Collection<MethodBean> definedInvocations = new ArrayList<MethodBean>();
